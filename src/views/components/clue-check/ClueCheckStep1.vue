        ...
        >
          ...
          <el-form-item label="属地" prop="area">
            <el-select
              ...
              style="width: 100%"
            >
              <el-option label="浒山街道" value="浒山街道" />
              <el-option label="古塘街道" value="古塘街道" />
              <el-option label="白沙路街道" value="白沙路街道" />
              <el-option label="宗汉街道" value="宗汉街道" />
              <el-option label="坎墩街道" value="坎墩街道" />
              <el-option label="龙山镇" value="龙山镇" />
              <el-option label="掌起镇" value="掌起镇" />
              <el-option label="观海卫镇" value="观海卫镇" />
              <el-option label="附海镇" value="附海镇" />
              <el-option label="桥头镇" value="桥头镇" />
              <el-option label="匡堰镇" value="匡堰镇" />
              <el-option label="逍林镇" value="逍林镇" />
              <el-option label="新浦镇" value="新浦镇" />
              <el-option label="胜山镇" value="胜山镇" />
              <el-option label="横河镇" value="横河镇" />
              <el-option label="崇寿镇" value="崇寿镇" />
              <el-option label="庵东镇" value="庵东镇" />
              <el-option label="长河镇" value="长河镇" />
              <el-option label="周巷镇" value="周巷镇" />
            </el-select>
          </el-form-item>
          ...
          <el-form-item label="问题类型" prop="problemType">
            <el-select
              ...
              style="width: 100%"
            >
              <el-option label="用电监控" value="用电监控" />
              <el-option label="环境信访" value="环境信访" />
...
const formRules = {
  ...
  jurisdictionOffice: [{ required: true, message: '请选择辖区所', trigger: 'change' }],
